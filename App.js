          ...
          {activeTab === 'backup' && (
            <ScrollView contentContainerStyle={styles.formContainer}>
              ...
              <View style={[styles.inputGroup, { backgroundColor: theme.inputBg, borderColor: theme.border, padding: 15 }]}>
                <TouchableOpacity style={[styles.addBtn, { height: 40 }]} onPress={handleExport}><Text style={styles.addBtnText}>Daten exportieren</Text></TouchableOpacity>
              </View>
              <View style={[styles.inputGroup, { backgroundColor: theme.inputBg, borderColor: theme.border, padding: 15, marginTop: 10 }]}>
                <TextInput style={[styles.input, { height: 100, textAlignVertical: 'top', paddingTop: 10, color: theme.text, backgroundColor: isDarkMode ? '#2C2C2E' : '#F0F0F0', borderRadius: 10, borderBottomWidth: 0 }]} placeholder="Backup-Code hier einfügen..." multiline value={importCode} onChangeText={setImportCode} placeholderTextColor={theme.subText} />
                <TouchableOpacity style={[styles.addBtn, { height: 40, marginTop: 15, backgroundColor: '#28A745' }]} onPress={handleImport}><Text style={styles.addBtnText}>Backup jetzt einspielen</Text></TouchableOpacity>
              </View>
            </ScrollView>
          )}
        </KeyboardAvoidingView>
